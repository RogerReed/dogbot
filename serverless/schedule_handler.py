...
def dispense_meal(event, context): 
    ...
    shadow_util.update_shadow_desired(THING_NAME, MEAL_THING_STATE_KEY, DISPENSE_SCHEDULED_THING_STATE_VALUE)

def dispense_treat(event, context): 
    log.info("dispense_treat")
    shadow_util.update_shadow_desired(THING_NAME, TREAT_THING_STATE_KEY, DISPENSE_SCHEDULED_THING_STATE_VALUE)

def dispense_water(event, context): 
    log.info("dispense_water")
    shadow_util.update_shadow_desired(THING_NAME, WATER_THING_STATE_KEY, DISPENSE_SCHEDULED_THING_STATE_VALUE)
